...
/*   Updated: 2021/01/13 17:31:17 by btammara         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
long double check_upper_side(t_parse *cub_file, int i)
{
	cub_file->len_of_c = 0;
	while (1) // UPPER
	{
...
long double check_lower_side(t_parse *cub_file, int i)
{
	cub_file->len_of_c = 0;
	while (1) // LOWER
	{
...
long double check_left_side(t_parse *cub_file, int i)
{
	cub_file->len_of_c = 0;
	while (1) // LEFT
	{
...
long double check_right_side(t_parse *cub_file, int i)
{
	cub_file->len_of_c = 0;
	while (1) // RIGHT
	{
